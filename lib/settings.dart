import 'package:agashya/internet_checker.dart';
import 'package:agashya/pick_image.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Text('Connection', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
          const SizedBox(
            height: 10,
          ),
           InkWell(
